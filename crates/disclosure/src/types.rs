...
pub struct OutputWitness {
    ...
    pub note: Vec<u8>,
    pub metadata: Option<MetadataOpening>,
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub enum Evidence {
    ZkReceipt(#[serde(with = "receipt_encoding")] Vec<u8>),
    PayloadKeys {
        keys: Vec<Vec<u8>>,
...
/// A signature authenticates its signer and bytes, not the truth of its assertion.
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
