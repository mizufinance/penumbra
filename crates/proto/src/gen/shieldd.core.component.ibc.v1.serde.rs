impl serde::Serialize for ClientConnections {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.ClientConnections", len)?;
        if !self.connections.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientConnections {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.ClientConnections")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.ClientConnections", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ClientCounter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.ClientCounter", len)?;
        if self.counter != 0 {
...
impl<'de> serde::Deserialize<'de> for ClientCounter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.ClientCounter")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.ClientCounter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ClientData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.ClientData", len)?;
        if !self.client_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.ClientData")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.ClientData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConnectionCounter {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.ConnectionCounter", len)?;
        if self.counter != 0 {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("counter", ToString::to_string(&self.counter).as_str())?;
...
impl<'de> serde::Deserialize<'de> for ConnectionCounter {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.ConnectionCounter")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.ConnectionCounter", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.ConsensusState", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.ConsensusState")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.ConsensusState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for FungibleTokenPacketData {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.FungibleTokenPacketData", len)?;
        if !self.denom.is_empty() {
...
impl<'de> serde::Deserialize<'de> for FungibleTokenPacketData {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.FungibleTokenPacketData")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.FungibleTokenPacketData", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GenesisContent {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.GenesisContent", len)?;
...
impl<'de> serde::Deserialize<'de> for GenesisContent {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.GenesisContent")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.GenesisContent", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IbcParameters {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.IbcParameters", len)?;
        if self.ibc_enabled {
...
impl<'de> serde::Deserialize<'de> for IbcParameters {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.IbcParameters")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.IbcParameters", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for IbcRelay {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.IbcRelay", len)?;
...
impl<'de> serde::Deserialize<'de> for IbcRelay {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.IbcRelay")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.IbcRelay", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Ics20Withdrawal {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.Ics20Withdrawal", len)?;
...
impl<'de> serde::Deserialize<'de> for Ics20Withdrawal {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.Ics20Withdrawal")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.Ics20Withdrawal", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for VerifiedHeights {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("shieldd.core.component.ibc.v1.VerifiedHeights", len)?;
        if !self.heights.is_empty() {
...
impl<'de> serde::Deserialize<'de> for VerifiedHeights {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct shieldd.core.component.ibc.v1.VerifiedHeights")
            }
        ...
        deserializer.deserialize_struct("shieldd.core.component.ibc.v1.VerifiedHeights", FIELDS, GeneratedVisitor)
    }
}
