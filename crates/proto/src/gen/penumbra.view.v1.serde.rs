...
impl serde::Serialize for transaction_planner_request::TransferOutput {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("penumbra.view.v1.TransactionPlannerRequest.TransferOutput", len)?;
...
impl<'de> serde::Deserialize<'de> for transaction_planner_request::TransferOutput {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct penumbra.view.v1.TransactionPlannerRequest.TransferOutput")
            }
        ...
        deserializer.deserialize_struct("penumbra.view.v1.TransactionPlannerRequest.TransferOutput", FIELDS, GeneratedVisitor)
    }
}
